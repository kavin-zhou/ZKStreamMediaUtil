...
@implementation MCVideoPlayerView
...
- (void)awakeFromNib {
    ...
    [self.progressSlider setThumbImage:[UIImage imageNamed:@"MCPlayer.bundle/thumbImage"] forState:UIControlStateNormal];
    [self.progressSlider setMaximumTrackImage:[UIImage imageNamed:@"MCPlayer.bundle/MaximumTrackImage"] forState:UIControlStateNormal];
    [self.progressSlider setMinimumTrackImage:[UIImage imageNamed:@"MCPlayer.bundle/MinimumTrackImage"] forState:UIControlStateNormal];
